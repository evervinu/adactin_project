...
public class Base_Class {
	...
	public static WebDriver browserLaunch(String name) {
		...
		if (name.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver", "E:\\Eclipse\\adactin\\Driver\\chromedriver.exe");
			driver = new ChromeDriver();
			driver.manage().window().maximize();
		} else if (name.equalsIgnoreCase("firefox")) {
			System.setProperty("webdriver.geco.driver", "E:\\Eclipse\\adactin\\Driver\\chromedriver.exe");
			driver.manage().window().maximize();
	...
	public static void action(String action1, String click, String contextclick, String doubleclick,
			String movetoelement, String draganddrop, WebElement element) {
